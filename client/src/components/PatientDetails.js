...
const PatientDetails = ({ patient }) => {
  return (
    <div className="bg-white shadow-md rounded-lg p-4 m-4 w-[23rem] h-48 overflow-hidden">
      ...
      <p className="text-gray-700 text-sm mb-1 truncate"><strong>Email: </strong>{patient.email}</p>
      <p className="text-gray-700 text-sm mb-1 truncate"><strong>Phone Number: </strong>{patient.phoneNumber}</p>
